...
<?= $this->section('content')?>
    <div class="container-fluid">
        <div class="row mt-3">
            ...
            <div class="col">
                <h2>Tablica Wyników <button type="button" class="btn btn-outline-dark float-right" data-mdb-ripple-color="dark"><a href="/CompetitionController/scoreboard">Wszystkie Wyniki</a></button></h2>
                <div class="row">
                    <div class="col-lg-12">
