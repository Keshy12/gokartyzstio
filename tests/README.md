...
use to test your application. Those details can be found in the documentation. UWU
...
via [Composer](https://getcomposer.org/) if you don't already have it installed globally. UWU
